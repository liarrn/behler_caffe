...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.BehlerDataParameter behler_data_param = 151;
  inline bool has_behler_data_param() const;
  inline void clear_behler_data_param();
  static const int kBehlerDataParamFieldNumber = 151;
  inline const ::caffe::BehlerDataParameter& behler_data_param() const;
  inline ::caffe::BehlerDataParameter* mutable_behler_data_param();
  inline ::caffe::BehlerDataParameter* release_behler_data_param();
  inline void set_allocated_behler_data_param(::caffe::BehlerDataParameter* behler_data_param);
 ...
 private:
  ...
  inline void set_has_behler_data_param();
  inline void clear_has_behler_data_param();
  ...
  ::caffe::BehlerDataParameter* behler_data_param_;
...
class BehlerDataParameter : public ::google::protobuf::Message {
 public:
  BehlerDataParameter();
  virtual ~BehlerDataParameter();

  BehlerDataParameter(const BehlerDataParameter& from);

  inline BehlerDataParameter& operator=(const BehlerDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const BehlerDataParameter& default_instance();

  void Swap(BehlerDataParameter* other);

  // implements Message ----------------------------------------------

  BehlerDataParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const BehlerDataParameter& from);
  void MergeFrom(const BehlerDataParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional string label_source = 2;
  inline bool has_label_source() const;
  inline void clear_label_source();
  static const int kLabelSourceFieldNumber = 2;
  inline const ::std::string& label_source() const;
  inline void set_label_source(const ::std::string& value);
  inline void set_label_source(const char* value);
  inline void set_label_source(const char* value, size_t size);
  inline ::std::string* mutable_label_source();
  inline ::std::string* release_label_source();
  inline void set_allocated_label_source(::std::string* label_source);
  ...
  // optional uint32 num_data_rows = 9;
  inline bool has_num_data_rows() const;
  inline void clear_num_data_rows();
  static const int kNumDataRowsFieldNumber = 9;
  inline ::google::protobuf::uint32 num_data_rows() const;
  inline void set_num_data_rows(::google::protobuf::uint32 value);

  // optional uint32 num_data_cols = 10;
  inline bool has_num_data_cols() const;
  inline void clear_num_data_cols();
  static const int kNumDataColsFieldNumber = 10;
  inline ::google::protobuf::uint32 num_data_cols() const;
  inline void set_num_data_cols(::google::protobuf::uint32 value);

  // optional uint32 num_label_rows = 11;
  inline bool has_num_label_rows() const;
  inline void clear_num_label_rows();
  static const int kNumLabelRowsFieldNumber = 11;
  inline ::google::protobuf::uint32 num_label_rows() const;
  inline void set_num_label_rows(::google::protobuf::uint32 value);

  // optional uint32 num_label_cols = 12;
  inline bool has_num_label_cols() const;
  inline void clear_num_label_cols();
  static const int kNumLabelColsFieldNumber = 12;
  inline ::google::protobuf::uint32 num_label_cols() const;
  inline void set_num_label_cols(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.BehlerDataParameter)
 private:
  inline void set_has_data_source();
  inline void clear_has_data_source();
  inline void set_has_label_source();
  inline void clear_has_label_source();
  inline void set_has_batch_size();
  inline void clear_has_batch_size();
  inline void set_has_shuffle();
  inline void clear_has_shuffle();
  inline void set_has_num_data_rows();
  inline void clear_has_num_data_rows();
  inline void set_has_num_data_cols();
  inline void clear_has_num_data_cols();
  inline void set_has_num_label_rows();
  inline void clear_has_num_label_rows();
  inline void set_has_num_label_cols();
  inline void clear_has_num_label_cols();
  ...
  ::std::string* label_source_;
  ::google::protobuf::uint32 batch_size_;
  bool shuffle_;
  ::google::protobuf::uint32 num_data_rows_;
  ::google::protobuf::uint32 num_data_cols_;
  ::google::protobuf::uint32 num_label_rows_;
  ::google::protobuf::uint32 num_label_cols_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static BehlerDataParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.BehlerDataParameter behler_data_param = 151;
inline bool LayerParameter::has_behler_data_param() const {
  return (_has_bits_[1] & 0x40000000u) != 0;
}
inline void LayerParameter::set_has_behler_data_param() {
  _has_bits_[1] |= 0x40000000u;
}
inline void LayerParameter::clear_has_behler_data_param() {
  _has_bits_[1] &= ~0x40000000u;
}
inline void LayerParameter::clear_behler_data_param() {
  if (behler_data_param_ != NULL) behler_data_param_->::caffe::BehlerDataParameter::Clear();
  clear_has_behler_data_param();
}
inline const ::caffe::BehlerDataParameter& LayerParameter::behler_data_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.behler_data_param)
  return behler_data_param_ != NULL ? *behler_data_param_ : *default_instance_->behler_data_param_;
}
inline ::caffe::BehlerDataParameter* LayerParameter::mutable_behler_data_param() {
  set_has_behler_data_param();
  if (behler_data_param_ == NULL) behler_data_param_ = new ::caffe::BehlerDataParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.behler_data_param)
  return behler_data_param_;
}
inline ::caffe::BehlerDataParameter* LayerParameter::release_behler_data_param() {
  clear_has_behler_data_param();
  ::caffe::BehlerDataParameter* temp = behler_data_param_;
  behler_data_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_behler_data_param(::caffe::BehlerDataParameter* behler_data_param) {
  delete behler_data_param_;
  behler_data_param_ = behler_data_param;
  if (behler_data_param) {
    set_has_behler_data_param();
  } else {
    clear_has_behler_data_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.behler_data_param)
}
...
// optional string data_source = 1;
inline bool BehlerDataParameter::has_data_source() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void BehlerDataParameter::set_has_data_source() {
  _has_bits_[0] |= 0x00000001u;
}
inline void BehlerDataParameter::clear_has_data_source() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void BehlerDataParameter::clear_data_source() {
  if (data_source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    data_source_->clear();
  }
  clear_has_data_source();
}
inline const ::std::string& BehlerDataParameter::data_source() const {
  // @@protoc_insertion_point(field_get:caffe.BehlerDataParameter.data_source)
  return *data_source_;
}
inline void BehlerDataParameter::set_data_source(const ::std::string& value) {
  set_has_data_source();
  if (data_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    data_source_ = new ::std::string;
  }
  data_source_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.BehlerDataParameter.data_source)
}
inline void BehlerDataParameter::set_data_source(const char* value) {
  set_has_data_source();
  if (data_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    data_source_ = new ::std::string;
  }
  data_source_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.BehlerDataParameter.data_source)
}
inline void BehlerDataParameter::set_data_source(const char* value, size_t size) {
  set_has_data_source();
  if (data_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    data_source_ = new ::std::string;
  }
  data_source_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.BehlerDataParameter.data_source)
}
inline ::std::string* BehlerDataParameter::mutable_data_source() {
  set_has_data_source();
  if (data_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    data_source_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.BehlerDataParameter.data_source)
  return data_source_;
}
inline ::std::string* BehlerDataParameter::release_data_source() {
  clear_has_data_source();
  if (data_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void BehlerDataParameter::set_allocated_data_source(::std::string* data_source) {
  if (data_source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete data_source_;
  }
  if (data_source) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.BehlerDataParameter.data_source)
}

// optional string label_source = 2;
inline bool BehlerDataParameter::has_label_source() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void BehlerDataParameter::set_has_label_source() {
  _has_bits_[0] |= 0x00000002u;
}
inline void BehlerDataParameter::clear_has_label_source() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void BehlerDataParameter::clear_label_source() {
  if (label_source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_source_->clear();
  }
  clear_has_label_source();
}
inline const ::std::string& BehlerDataParameter::label_source() const {
  // @@protoc_insertion_point(field_get:caffe.BehlerDataParameter.label_source)
  return *label_source_;
}
inline void BehlerDataParameter::set_label_source(const ::std::string& value) {
  set_has_label_source();
  if (label_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_source_ = new ::std::string;
  }
  label_source_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.BehlerDataParameter.label_source)
}
inline void BehlerDataParameter::set_label_source(const char* value) {
  set_has_label_source();
  if (label_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_source_ = new ::std::string;
  }
  label_source_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.BehlerDataParameter.label_source)
}
inline void BehlerDataParameter::set_label_source(const char* value, size_t size) {
  set_has_label_source();
  if (label_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_source_ = new ::std::string;
  }
  label_source_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.BehlerDataParameter.label_source)
}
inline ::std::string* BehlerDataParameter::mutable_label_source() {
  set_has_label_source();
  if (label_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_source_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.BehlerDataParameter.label_source)
  return label_source_;
}
inline ::std::string* BehlerDataParameter::release_label_source() {
  clear_has_label_source();
  if (label_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = label_source_;
    label_source_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void BehlerDataParameter::set_allocated_label_source(::std::string* label_source) {
  if (label_source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete label_source_;
  }
  if (label_source) {
    set_has_label_source();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.BehlerDataParameter.label_source)
}

// optional uint32 batch_size = 4 [default = 1];
inline bool BehlerDataParameter::has_batch_size() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void BehlerDataParameter::set_has_batch_size() {
  _has_bits_[0] |= 0x00000004u;
}
inline void BehlerDataParameter::clear_has_batch_size() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void BehlerDataParameter::clear_batch_size() {
  batch_size_ = 1u;
  clear_has_batch_size();
}
inline ::google::protobuf::uint32 BehlerDataParameter::batch_size() const {
  // @@protoc_insertion_point(field_get:caffe.BehlerDataParameter.batch_size)
  return batch_size_;
}
inline void BehlerDataParameter::set_batch_size(::google::protobuf::uint32 value) {
  set_has_batch_size();
  batch_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.BehlerDataParameter.batch_size)
}

// optional bool shuffle = 8 [default = false];
inline bool BehlerDataParameter::has_shuffle() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void BehlerDataParameter::set_has_shuffle() {
  _has_bits_[0] |= 0x00000008u;
}
inline void BehlerDataParameter::clear_has_shuffle() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void BehlerDataParameter::clear_shuffle() {
  shuffle_ = false;
  clear_has_shuffle();
}
inline bool BehlerDataParameter::shuffle() const {
  // @@protoc_insertion_point(field_get:caffe.BehlerDataParameter.shuffle)
  return shuffle_;
}
inline void BehlerDataParameter::set_shuffle(bool value) {
  set_has_shuffle();
  shuffle_ = value;
  // @@protoc_insertion_point(field_set:caffe.BehlerDataParameter.shuffle)
}

// optional uint32 num_data_rows = 9;
inline bool BehlerDataParameter::has_num_data_rows() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void BehlerDataParameter::set_has_num_data_rows() {
  _has_bits_[0] |= 0x00000010u;
}
inline void BehlerDataParameter::clear_has_num_data_rows() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void BehlerDataParameter::clear_num_data_rows() {
  num_data_rows_ = 0u;
  clear_has_num_data_rows();
}
inline ::google::protobuf::uint32 BehlerDataParameter::num_data_rows() const {
  // @@protoc_insertion_point(field_get:caffe.BehlerDataParameter.num_data_rows)
  return num_data_rows_;
}
inline void BehlerDataParameter::set_num_data_rows(::google::protobuf::uint32 value) {
  set_has_num_data_rows();
  num_data_rows_ = value;
  // @@protoc_insertion_point(field_set:caffe.BehlerDataParameter.num_data_rows)
}

// optional uint32 num_data_cols = 10;
inline bool BehlerDataParameter::has_num_data_cols() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void BehlerDataParameter::set_has_num_data_cols() {
  _has_bits_[0] |= 0x00000020u;
}
inline void BehlerDataParameter::clear_has_num_data_cols() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void BehlerDataParameter::clear_num_data_cols() {
  num_data_cols_ = 0u;
  clear_has_num_data_cols();
}
inline ::google::protobuf::uint32 BehlerDataParameter::num_data_cols() const {
  // @@protoc_insertion_point(field_get:caffe.BehlerDataParameter.num_data_cols)
  return num_data_cols_;
}
inline void BehlerDataParameter::set_num_data_cols(::google::protobuf::uint32 value) {
  set_has_num_data_cols();
  num_data_cols_ = value;
  // @@protoc_insertion_point(field_set:caffe.BehlerDataParameter.num_data_cols)
}

// optional uint32 num_label_rows = 11;
inline bool BehlerDataParameter::has_num_label_rows() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void BehlerDataParameter::set_has_num_label_rows() {
  _has_bits_[0] |= 0x00000040u;
}
inline void BehlerDataParameter::clear_has_num_label_rows() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void BehlerDataParameter::clear_num_label_rows() {
  num_label_rows_ = 0u;
  clear_has_num_label_rows();
}
inline ::google::protobuf::uint32 BehlerDataParameter::num_label_rows() const {
  // @@protoc_insertion_point(field_get:caffe.BehlerDataParameter.num_label_rows)
  return num_label_rows_;
}
inline void BehlerDataParameter::set_num_label_rows(::google::protobuf::uint32 value) {
  set_has_num_label_rows();
  num_label_rows_ = value;
  // @@protoc_insertion_point(field_set:caffe.BehlerDataParameter.num_label_rows)
}

// optional uint32 num_label_cols = 12;
inline bool BehlerDataParameter::has_num_label_cols() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void BehlerDataParameter::set_has_num_label_cols() {
  _has_bits_[0] |= 0x00000080u;
}
inline void BehlerDataParameter::clear_has_num_label_cols() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void BehlerDataParameter::clear_num_label_cols() {
  num_label_cols_ = 0u;
  clear_has_num_label_cols();
}
inline ::google::protobuf::uint32 BehlerDataParameter::num_label_cols() const {
  // @@protoc_insertion_point(field_get:caffe.BehlerDataParameter.num_label_cols)
  return num_label_cols_;
}
inline void BehlerDataParameter::set_num_label_cols(::google::protobuf::uint32 value) {
  set_has_num_label_cols();
  num_label_cols_ = value;
  // @@protoc_insertion_point(field_set:caffe.BehlerDataParameter.num_label_cols)
}
